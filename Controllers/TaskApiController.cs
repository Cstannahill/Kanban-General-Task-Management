...
namespace Sabio.Web.Api.Controllers
{
    ...
    public class TaskApiController : ControllerBase
    {
        ...
        [HttpPost("boards")]
        public ActionResult<ItemResponse<int>> CreateTaskBoard(TaskBoardAddRequest model)
        {
            int userId = _authService.GetCurrentUserId();
            int code = 201;
            int id = 0;
            ...
            try
            {
                id = _service.CreateTaskBoard(model, userId);
                response = new ItemResponse<int> { Item = id };
            }
            catch (Exception ex)
            {
        ...
        [HttpPost("categories")]
        public ActionResult<ItemResponse<int>> CreateCategory(TaskCategoryAddRequest model)
        {
            int userId = _authService.GetCurrentUserId();
            int code = 201;
            BaseResponse response = null;
            ...
            try
            {
                int id = _service.CreateCategory(model);
